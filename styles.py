...
<span style="font-size: 0.65rem; color: {status_color}; font-weight: 800; text-transform: uppercase; letter-spacing: 0.08em;">{status}</span>
</div>
</div>
</div>
...
<div style="padding-top: 0.75rem; border-top: 1px solid rgba(255,255,255,0.05); display: flex; justify-content: space-between; align-items: center;">
<span style="font-size: 0.7rem; color: #64748B; text-transform: uppercase; font-weight: 700; letter-spacing: 0.05em;">Capacity (TVL)</span>
